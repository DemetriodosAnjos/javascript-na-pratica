export const listaDeAulas = [
  {
    ...
    descricao:
      "Passo a passo prático abordando constantes, funções, métodos...",
    timestamps: [
...
// Criação de elementos no HTML (div, span)
...
// Injeção de texto nos elementos do HTML
textoDescritivo.textContent = "Clique no chevron para expandir";
menuContent.textContent = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. It has survived not only many decades, but also the leap into electronic typesetting, remaining essentially unchanged.";
 

// Injeção do caracter especial "ícone" no HTML
iconeChevron.innerHTML = "▼";

// Inclusão dos elementos "filhos" dentro dos elementos "Pai"
...
// Função nomeada responsável pela execução do componente
...
// Ouvinte do clique no ícone chevron Down/Up
